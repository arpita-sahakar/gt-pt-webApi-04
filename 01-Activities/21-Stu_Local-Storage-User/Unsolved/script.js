...
function renderLastRegistered() {
  ...
  var lastRegEmail = localStorage.getItem("emailKey");
  var lastRegPass = localStorage.getItem("passwordKey");

  if(lastRegEmail != null && lastRegPass != null){
    userEmailSpan.textContent = lastRegEmail;
    userPasswordSpan.textContent = lastRegPass;
  }
